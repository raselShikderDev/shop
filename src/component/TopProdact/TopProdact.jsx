  ...
  return (
    <section className="py-16 dark:bg-gray-900  dark:text-white">
      <div className="container text-left">
        ...
        <h2 data-aos="fade-up" className="font-semibold text-4xl">Best Products</h2>
        ...
        <div className="mt-28">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-24 md:gap-5 place-items-center">
            {productsData.map((item) => {
              ...
              return (
                <div
                  data-aos="zoom-in"
                  key={id}
                  className=" bg-white dark:bg-gray-800 hover:bg-black/80 dark:hover:bg-primary hover:bg-gray-600 hover:text-white rounded-md group shadow-xl "
                >
                  ...
                  <div className="text-center p-4">
                    ...
                    <button
                      onClick={() =>
                        alert("Sorry! We're not accepting order ourrently.")
                      }
                      className="bg-primary mt-4 px-4 py-2 rounded-full text-white hover:scale-105 group-hover:bg-white group-hover:text-primary"
                    >
                      Order Now
                    </button>
                  </div>
